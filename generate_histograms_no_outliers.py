...
plt.tight_layout()
plt.savefig(os.path.join(FIG, "rt_histograms.png"), dpi=300, bbox_inches="tight")
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(FIG, "rt_histograms_overlaid.png"), dpi=300, bbox_inches="tight")
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(FIG, "participant_rt_strip.png"), dpi=300, bbox_inches="tight")
plt.close()
...
fig_log.savefig(os.path.join(FIG, "rt_log_histograms.png"), dpi=300, bbox_inches="tight")
plt.close(fig_log)
...
ax.legend(fontsize=10)
plt.tight_layout()
plt.savefig(os.path.join(FIG, "paired_difference_bar.png"), dpi=300, bbox_inches="tight")
plt.close()
